...
const StripeTermsAndConditionsText = () => {   
  return (
    <Container>
      ...
      <br/>
      <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the http://www.todo-sheet.com website (the "Service") operated by Tasksheet ("us", "we", or "our").</p>
      <br/>
