...
const SettingsUserSubscriptionTrial = () => {
  ...
  const userSubscriptionEndDate = useSelector((state: IAppState) => state.user.todosheetSubscription.endDate)
  ...
  return (
    <>
      <ExpirationDate>
        ...
        If you'd like to continue using Todosheet after that date, please choose one of our two subscription plans below.
        Both plans include unlimited access to all Todosheet features.
      </ExpirationDate>
      <Container>
        <ContentContainer>
          <Header>
          ...
          <SubscriptionTypesContainer>
            ...
            <SubscriptionType
              ...
              <Divider />
              <SubscriptionTypeDescription>
                Billed immediately, you'll have access to Todosheet and all of its features forever.
              </SubscriptionTypeDescription>
            </SubscriptionType>
          </SubscriptionTypesContainer>
        </ContentContainer>
