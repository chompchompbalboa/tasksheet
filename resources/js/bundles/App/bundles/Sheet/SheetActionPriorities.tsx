...
const SheetActionSheetCellPriorities = ({
  ...
  return (
    <SheetActionButton
      containerHoverBackgroundColor={activeSheetPriority && activeSheetPriority.backgroundColor}
      containerHoverColor={activeSheetPriority && activeSheetPriority.color}
